...
import {
  type BuildCrossTableOptions,
  type CrossTableLeftMetaColumn,
  type LeftCrossTreeNode,
  ROW_KEY,
  type TopCrossTreeNode,
} from '../cross-table'
...
export default function buildCrossTreeTable(
  ...
  /** 获取表格的列配置 */
  function getColumns(): FluxColumn[] {
    return [
      {
        ...primaryColumn,
    ...
    function getDataPartColumns() {
      ...
      function dfs(nodes: TopCrossTreeNode[], ctx: { depth: number }): FluxColumn[] {
    ...
    function getDataColumn(topNode: TopCrossTreeNode, topDepth: number): FluxColumn {
