...
export type VisibleColumnDescriptor =
  ...
  | { type: 'normal'; colIndex: number; col: FluxColumn }
...
export interface RenderInfo {
  ...
  flat: { full: FluxColumn[]; left: FluxColumn[]; center: FluxColumn[]; right: FluxColumn[] }
  nested: { full: FluxColumn[]; left: FluxColumn[]; center: FluxColumn[]; right: FluxColumn[] }
